...
def main():
    dataDir = '/Users/zhoujiancong/datasets/coco2017'

    root_path = ''
    support_path = os.path.join(root_path, 'all_10_shot_support')
    ...
    for dataType in ['train2017']:  # , 'train2017']:
        ...
        annFile = os.path.join(root_path, 'new_annotations/novel_10_shot_instances_train2017.json')
...
if __name__ == '__main__':
    since = time.time()
    support_df = main()
    support_df.to_pickle("./novel_10_shot_support_df.pkl")
